...
{{--                        <a href="{{\Illuminate\Support\Facades\URL::route("admin.signup")}}" class="signup-image-link">Create an account</a>--}}
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="login-form" id="login-form" action="{{\Illuminate\Support\Facades\URL::route("admin.login-post")}}">
                            {{ csrf_field() }}
