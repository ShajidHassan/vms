            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="{{\Illuminate\Support\Facades\URL::route("marchant.signup")}}" class="signup-image-link">Create an account</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="login-form" id="login-form" action="{{\Illuminate\Support\Facades\URL::route("marchant.signin-post")}}">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label for="your_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input required type="text" name="email" id="email" required="" placeholder="Your email"/>
                            </div>
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input required type="password" name="password" required="" id="your_pass" placeholder="Password"/>
                            </div>
                            <div class="form-group">
