...
height:40px;
          ...
          <div class="widget-content nopadding">
            ...
            @endif
            <form class="form-horizontal" method="post" action="{{ \Illuminate\Support\Facades\URL::route('admin.edit_category',['id' => $categoryDetails->id]) }}" name="add_category" id="add_category" novalidate="novalidate"> {{ csrf_field() }}
