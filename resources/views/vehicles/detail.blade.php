					...
					<div class="view-product">
						...
						<div class="col-sm-7">
							...
							@if($vehicleDetails->booking_status !== "booked")
									...
									<a href="{{ URL::to('/booking', ["id" => $vehicleDetails->id]) }}" class="btn btn-primary"> Booking </a>
							@else
							...
							<div class="product-information"><!--/product-information-->
								...
								<span>
									...
									<h3>Price : <span>{{ $vehicleDetails->sale_price ?? "NA" }} Tk</span></h3>
								</span>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="showroom" >
								<div class="col-sm-12">
									<div class="borderclass">
										<h4>Showroom Name: <strong>{{ $vehicleDetails-> show_room}}</strong></h4>
