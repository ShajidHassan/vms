    ...
    <div id="content">
        ...
        <div class="widget-box">
            ...
            <div style="background-color:white; " class="widget-content nopadding">
                ...
                @endif
                <form id="acc_add_account" class="form-horizontal" method="post" action="{{ \Illuminate\Support\Facades\URL::route("admin.post_account") }}">
                    {{ csrf_field() }}
                    ...
                    <div  class="control-group">
                        <label for="acc_number" class="control-label">Acc. Number</label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label for="amount" class="control-label">Initialize Amount:</label>
                        <div class="controls">
                            <input type="number" name="amount" id="amount" required />
                        </div>
                    </div>
                    <div class="form-actions">
                        <input name="add_account" type="submit" value="Add Account" class="btn btn-primary btn-block">
                    </div>
                </form>
            </div>
@endsection