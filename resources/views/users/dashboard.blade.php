...
<!--End-Action boxes-->    
 ...
 <section id="hero" class="d-flex flex-column justify-content-center align-items-center"> 
    ...
    <div class="container"data-aos="fade-in">
      ...
      <span class="text2"><center><strong><i>User Panel</i></strong></center></font></span>
    </div>
  </section>
<!--Chart-box-->  <!--  
    <div class="row-fluid">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <ul class="recent-posts">
              <li>
                <div class="user-thumb"> <img width="40" height="40" alt="User" src="{{ asset('marchant') }}"> </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content tab-content">
            <div id="tab1" class="tab-pane active">
              ...
              <img src="{{ asset('marchant') }}" alt="demo-image"/></div>
            <div id="tab2" class="tab-pane"> <img src="{{ asset('marchant') }}" alt="demo-image"/>
              <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment.</p>
            </div>
