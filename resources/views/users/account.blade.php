                  ...
                  <tbody>
                    @foreach($accounts as $account)
                      <tr>
                        ...
                        <td class="center">
                          <a href="{{\Illuminate\Support\Facades\URL::route("user.edit_account",['id' => $account->id])}}" class="btn btn-info btn" title="edit">Edit</a>
                          <a href="{{\Illuminate\Support\Facades\URL::route("user.view_account",['id' => $account->id])}}" class="btn btn-success btn" title="View">Detail</a>
                          ...
                          <form id="delete_account_{{$account->id}}" method="post" action="{{ \Illuminate\Support\Facades\URL::route('user.delete_account') }}">
