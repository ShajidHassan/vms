...
{{--                  <td>{{ $vehicle->selling }}</td>--}}
                  <td>
                	...
                	<td class="center">
                      <a href="{{\Illuminate\Support\Facades\URL::route("vechicles.sold",['id'=>$vehicle->id])}}"  class="btn btn-success btn">New Sold</a>
                      <a href="{{\Illuminate\Support\Facades\URL::route("vechicles.details",['id'=>$vehicle->id])}}"  class="btn btn-success btn">Purchases</a>
                      <a href="{{\Illuminate\Support\Facades\URL::route("vechicles.sales",['id'=>$vehicle->id])}}"  class="btn btn-success btn">Sales</a>
                      <a href="{{\Illuminate\Support\Facades\URL::route("vechicles.edit",['id'=>$vehicle->id])}}" class="btn btn-primary btn-xs" >Edit</a>
{{--                <a href="{{ URL::to('/marchant/add-images/'.$vehicle->id) }}" class="btn btn-info btn-xs" title="Add Images">Add</a>--}}
                    <a onclick='window.confirm("are you sure ?") && document.getElementById("delete_vechicle_{{$vehicle->id}}").submit(); return false;' class="btn btn-danger btn-xsi" >Trash</a>
                    </td>
                    <form id="delete_vechicle_{{$vehicle->id}}" method="post" action="{{ \Illuminate\Support\Facades\URL::route('vechicles.delete') }}">
...
{{--            <h5 class="modal-title" id="exampleModalLabel"><strong><i>ARE YOU SURE ?</i></strong></h5>--}}
...
{{--            <a class="btn btn-primary" href="{{ URL::to('/marchant/delete-vehicle/'.$vehicle->id) }}"><strong>Delete</strong></a>--}}
{{--          </div>--}}
{{--        </div>--}}
{{--      </div>--}}
{{--    </div>--}}
