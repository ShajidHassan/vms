...
<div id="content">
  <div id="content-header">
    <h1 style="color:black; font-weight:bold">Purchase New</h1>
...
height:40px;
          ...
          <div style="background-color:white; " class="widget-content nopadding">
            <form id="new_purchase_form" class="form-horizontal" enctype="multipart/form-data" method="post" action="{{ URL::to('/marchant/add-vehicle') }}" novalidate="novalidate">
              {{ csrf_field() }}
                ...
                <div class="control-group">
                    ...
                    <label class="control-label">P. Quantity</label>
                    <div class="controls">
                ...
                <input type="submit" value="New Purchases" class="btn btn-primary btn-block">
              </div>
            </form>
          </div>
@endsection