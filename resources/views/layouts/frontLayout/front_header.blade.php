            ...
            <div class="social-icons pull-right">
              <ul class="nav navbar-nav">
                ...
                @if(session()->get("user_email"))
                  <li><a href="{{ url('/user/dashbord')}}"><i class="fa fa-sign-in"></i>{{session()->get("user_email")}}</a></li>
                @elseif(session()->get("marchant_email"))
                  <li><a href="{{ url('/marchant/dashbord')}}"><i class="fa fa-sign-in"></i>{{session()->get("marchant_email")}}</a></li>
                @else
                  <li><a href="{{ url('/marchant-signin')}}"><i class="fa fa-sign-in"></i>Merchant Sign in</a></li>
...
{{--              <form action="{{ url('/search-vehicles') }}" method="get">--}}
